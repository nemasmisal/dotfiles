...
M.get_template_location_for_component = function(callback)
  execute_command('textDocument/getTemplateLocationForComponent', callback)
end
...
vim.keymap.set("n", "<leader>at", M.goto_template_for_component, opts)
vim.keymap.set("n", "<leader>ac", M.goto_component_with_template_file, opts)
vim.keymap.set("n", "<leader>aT", M.get_template_tcb, opts)
